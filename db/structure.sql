...
CREATE TABLE IF NOT EXISTS "users" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "email" varchar DEFAULT '' NOT NULL, "encrypted_password" varchar DEFAULT '' NOT NULL, "reset_password_token" varchar, "reset_password_sent_at" datetime, "remember_created_at" datetime, "created_at" datetime(6) NOT NULL, "updated_at" datetime(6) NOT NULL, "role" integer DEFAULT 0, "name" varchar /*application='SchoolApp'*/, "description" text /*application='SchoolApp'*/, "avatar" varchar /*application='SchoolApp'*/, "invitation_token" varchar /*application='SchoolApp'*/, "invitation_created_at" datetime(6) /*application='SchoolApp'*/, "invitation_sent_at" datetime(6) /*application='SchoolApp'*/, "invitation_accepted_at" datetime(6) /*application='SchoolApp'*/, "invitation_limit" integer /*application='SchoolApp'*/, "invited_by_type" varchar /*application='SchoolApp'*/, "invited_by_id" integer /*application='SchoolApp'*/, "invitations_count" integer DEFAULT 0 /*application='SchoolApp'*/);
